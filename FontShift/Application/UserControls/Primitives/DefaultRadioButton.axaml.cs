...
{
    public class DefaultRadioButton : RadioButton
    {
        public static readonly StyledProperty<Orientation> OrientationProperty =
            AvaloniaProperty.Register<DefaultRadioButton, Orientation>(nameof(OrientationProperty), Orientation.Horizontal);
        ...
        public static readonly StyledProperty<Thickness> TextMarginProperty =
            AvaloniaProperty.Register<DefaultRadioButton, Thickness>(nameof(TextMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<string> TextProperty =
            AvaloniaProperty.Register<DefaultRadioButton, string>(nameof(TextProperty), null);
        ...
        public static readonly StyledProperty<Thickness> IconMarginProperty =
            AvaloniaProperty.Register<DefaultRadioButton, Thickness>(nameof(IconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<IImage> IconProperty =
            AvaloniaProperty.Register<DefaultRadioButton, IImage>(nameof(IconProperty), null);
        ...
        public static readonly StyledProperty<double> IconScaleFactorProperty =
            AvaloniaProperty.Register<DefaultRadioButton, double>(nameof(IconScaleFactorProperty), 0.0);
        ...
        public static readonly DirectProperty<DefaultRadioButton, double> IconWidthProperty =
            AvaloniaProperty.RegisterDirect<DefaultRadioButton, double>(nameof(IconWidthProperty), o => o.IconWidth);
        ...
        public static readonly DirectProperty<DefaultRadioButton, double> IconHeightProperty =
            AvaloniaProperty.RegisterDirect<DefaultRadioButton, double>(nameof(IconHeightProperty), o => o.IconHeight);
        ...
        public static readonly StyledProperty<Thickness> PathIconMarginProperty =
            AvaloniaProperty.Register<DefaultRadioButton, Thickness>(nameof(PathIconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<Geometry> PathIconDataProperty =
            AvaloniaProperty.Register<DefaultRadioButton, Geometry>(nameof(PathIconDataProperty), null);
        ...
        public static readonly StyledProperty<double> PathIconWidthProperty =
            AvaloniaProperty.Register<DefaultRadioButton, double>(nameof(PathIconWidthProperty), 32);
        ...
        public static readonly StyledProperty<double> PathIconHeightProperty =
            AvaloniaProperty.Register<DefaultRadioButton, double>(nameof(PathIconHeightProperty), 32);

...
{
    public class MenuStaticItem : TemplatedControl
    {
        public static readonly StyledProperty<HorizontalAlignment> HorizontalContentAlignmentProperty =
            AvaloniaProperty.Register<MenuStaticItem, HorizontalAlignment>(nameof(HorizontalContentAlignmentProperty), HorizontalAlignment.Center);
        ...
        public static readonly StyledProperty<VerticalAlignment> VerticalContentAlignmentProperty =
            AvaloniaProperty.Register<MenuStaticItem, VerticalAlignment>(nameof(VerticalContentAlignmentProperty), VerticalAlignment.Center);
        ...
        public static readonly StyledProperty<Orientation> OrientationProperty =
            AvaloniaProperty.Register<MenuStaticItem, Orientation>(nameof(OrientationProperty), Orientation.Horizontal);
        ...
        public static readonly StyledProperty<Thickness> TextMarginProperty =
            AvaloniaProperty.Register<MenuStaticItem, Thickness>(nameof(TextMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<string> TextProperty =
            AvaloniaProperty.Register<MenuStaticItem, string>(nameof(TextProperty), null);
        ...
        public static readonly StyledProperty<Thickness> IconMarginProperty =
            AvaloniaProperty.Register<MenuStaticItem, Thickness>(nameof(IconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<IImage> IconProperty =
            AvaloniaProperty.Register<MenuStaticItem, IImage>(nameof(IconProperty), null);
        ...
        public static readonly StyledProperty<double> IconScaleFactorProperty =
            AvaloniaProperty.Register<MenuStaticItem, double>(nameof(IconScaleFactorProperty), 0.0);
        ...
        public static readonly DirectProperty<MenuStaticItem, double> IconWidthProperty =
            AvaloniaProperty.RegisterDirect<MenuStaticItem, double>(nameof(IconWidthProperty), o => o.IconWidth);
        ...
        public static readonly DirectProperty<MenuStaticItem, double> IconHeightProperty =
            AvaloniaProperty.RegisterDirect<MenuStaticItem, double>(nameof(IconHeightProperty), o => o.IconHeight);
        ...
        public static readonly StyledProperty<Thickness> PathIconMarginProperty =
            AvaloniaProperty.Register<MenuStaticItem, Thickness>(nameof(PathIconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<Geometry> PathIconDataProperty =
            AvaloniaProperty.Register<MenuStaticItem, Geometry>(nameof(PathIconDataProperty), null);
        ...
        public static readonly StyledProperty<double> PathIconWidthProperty =
            AvaloniaProperty.Register<MenuStaticItem, double>(nameof(PathIconWidthProperty), 32);
        ...
        public static readonly StyledProperty<double> PathIconHeightProperty =
            AvaloniaProperty.Register<MenuStaticItem, double>(nameof(PathIconHeightProperty), 32);

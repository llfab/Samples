...
namespace FontShift.Application.UserControls.Primitives
{
    public class DefaultButton : Button
    {
        ...
        public static readonly StyledProperty<Orientation> OrientationProperty =
            AvaloniaProperty.Register<DefaultButton, Orientation>(nameof(OrientationProperty), Orientation.Horizontal);
        ...
        public static readonly StyledProperty<Thickness> TextMarginProperty =
            AvaloniaProperty.Register<DefaultButton, Thickness>(nameof(TextMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<string> TextProperty =
            AvaloniaProperty.Register<DefaultButton, string>(nameof(TextProperty), null);
        ...
        public static readonly StyledProperty<Thickness> IconMarginProperty =
            AvaloniaProperty.Register<DefaultButton, Thickness>(nameof(IconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<IImage> IconProperty =
            AvaloniaProperty.Register<DefaultButton, IImage>(nameof(IconProperty), null);
        ...
        public static readonly StyledProperty<double> IconScaleFactorProperty =
            AvaloniaProperty.Register<DefaultButton, double>(nameof(IconScaleFactorProperty), 0.0);
        ...
        public static readonly DirectProperty<DefaultButton, double> IconWidthProperty =
            AvaloniaProperty.RegisterDirect<DefaultButton, double>(nameof(IconWidthProperty), o => o.IconWidth);
        ...
        public static readonly DirectProperty<DefaultButton, double> IconHeightProperty =
            AvaloniaProperty.RegisterDirect<DefaultButton, double>(nameof(IconHeightProperty), o => o.IconHeight);
        ...
        public static readonly StyledProperty<Thickness> PathIconMarginProperty =
            AvaloniaProperty.Register<DefaultButton, Thickness>(nameof(PathIconMarginProperty), new Thickness(0));
        ...
        public static readonly StyledProperty<Geometry> PathIconDataProperty =
            AvaloniaProperty.Register<DefaultButton, Geometry>(nameof(PathIconDataProperty), null);
        ...
        public static readonly StyledProperty<double> PathIconWidthProperty =
            AvaloniaProperty.Register<DefaultButton, double>(nameof(PathIconWidthProperty), 32);
        ...
        public static readonly StyledProperty<double> PathIconHeightProperty =
            AvaloniaProperty.Register<DefaultButton, double>(nameof(PathIconHeightProperty), 32);

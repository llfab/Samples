...
{
    public class GuidanceInfoTemplatingViewModel : GuidanceWorkflowStateViewModelBase
    {
        #region Constants
        ...
        public GuidanceInfoTemplatingViewModel()
        ...
        {
            _notAvailableText = AvaloniaUtils.GetResource<string>("GuidanceInfoTemplatingViewNotAvailable");
        }

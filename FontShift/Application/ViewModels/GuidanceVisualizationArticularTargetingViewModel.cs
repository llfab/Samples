...
{
    public class GuidanceVisualizationArticularTargetingViewModel : GuidanceWorkflowStateViewModelBase
    {
        #region Constants
        ...
        public GuidanceVisualizationArticularTargetingViewModel()

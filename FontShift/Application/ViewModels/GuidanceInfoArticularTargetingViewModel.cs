...
{
    public class GuidanceInfoArticularTargetingViewModel : GuidanceWorkflowStateViewModelBase
    {
        #region Constants
        ...
        public GuidanceInfoArticularTargetingViewModel()
        ...
        {
            _notAvailableText = AvaloniaUtils.GetResource<string>("GuidanceInfoArticularTargetingViewNotAvailable");
        }
